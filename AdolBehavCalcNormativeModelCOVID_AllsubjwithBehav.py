...
if run_fit:
    ...
    Z_time1_behav.to_csv(outputdirname+f'/Z_scores_all_meltzoff_cogn_behav_visit1_{n_splits}_splits_allsplits.csv')
    Z_time2_behav.to_csv(outputdirname+f'/Z_scores_all_meltzoff_cogn_behav_visit2_{n_splits}_splits_allsplits.csv')

Z_time1_behav = pd.read_csv(outputdirname+f'/Z_scores_all_meltzoff_cogn_behav_visit1_{n_splits}_splits_allsplits.csv',
                            usecols=lambda col: not col.startswith('Unnamed'))
Z_time2_behav = pd.read_csv(outputdirname+f'/Z_scores_all_meltzoff_cogn_behav_visit2_{n_splits}_splits_allsplits.csv',
                            usecols=lambda col: not col.startswith('Unnamed'))

Z_time1_avg_allsplits = Z_time1_behav.groupby(by=['subject']).mean()
...
Z_time1_avg_allsplits.to_csv(outputdirname+f'/Z_scores_all_meltzoff_cogn_behav_visit1_avg{n_splits}_splits.csv')
Z_time2_avg_allsplits.to_csv(outputdirname+f'/Z_scores_all_meltzoff_cogn_behav_visit2_avg{n_splits}_splits.csv')


behaviors = ['FlankerSU', 'DCSU']

reject_val, pvals_corr_both_genders = calc_ef_stats(Z_time2_avg_allsplits,outputdirname)
